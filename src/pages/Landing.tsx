      ...
      <nav className="fixed top-0 w-full z-40 border-b border-white/5 bg-black/50 backdrop-blur-md transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-12">
            <a href="#vision" className="text-xs text-zinc-400 hover:text-white transition-colors uppercase tracking-widest font-sans">Vision</a>
            <a href="#alpha" className="text-xs text-zinc-400 hover:text-white transition-colors uppercase tracking-widest font-sans text-green-400">Alpha</a>
            <a href="#lattice" className="text-xs text-zinc-400 hover:text-white transition-colors uppercase tracking-widest font-sans">Lattice</a>
            <a href="#connect" className="text-xs text-zinc-400 hover:text-white transition-colors uppercase tracking-widest font-sans">Connect</a>
            <Link to="/todo" className="text-xs text-purple-300 hover:text-white transition-colors uppercase tracking-widest font-sans">To Do</Link>
          </div>
